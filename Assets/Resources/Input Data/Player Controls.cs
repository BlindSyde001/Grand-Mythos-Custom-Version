...
public partial class @PlayerControls : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""d1339d24-8ea8-4758-a6a9-e640a18395b1"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    private IOverworldMapActions m_OverworldMapActionsCallbackInterface;
    ...
    public struct OverworldMapActions
    {
        ...
        {
            if (m_Wrapper.m_OverworldMapActionsCallbackInterface != null)
            {
                @Move.started -= m_Wrapper.m_OverworldMapActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_OverworldMapActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_OverworldMapActionsCallbackInterface.OnMove;
                @Interact.started -= m_Wrapper.m_OverworldMapActionsCallbackInterface.OnInteract;
                @Interact.performed -= m_Wrapper.m_OverworldMapActionsCallbackInterface.OnInteract;
                @Interact.canceled -= m_Wrapper.m_OverworldMapActionsCallbackInterface.OnInteract;
                @OpenMenu.started -= m_Wrapper.m_OverworldMapActionsCallbackInterface.OnOpenMenu;
                @OpenMenu.performed -= m_Wrapper.m_OverworldMapActionsCallbackInterface.OnOpenMenu;
                @OpenMenu.canceled -= m_Wrapper.m_OverworldMapActionsCallbackInterface.OnOpenMenu;
            }
            m_Wrapper.m_OverworldMapActionsCallbackInterface = instance;
            if (instance != null)
            {
    ...
    private ITitleMapActions m_TitleMapActionsCallbackInterface;
    ...
    public struct TitleMapActions
    {
        ...
        {
            if (m_Wrapper.m_TitleMapActionsCallbackInterface != null)
            {
                @Newaction.started -= m_Wrapper.m_TitleMapActionsCallbackInterface.OnNewaction;
                @Newaction.performed -= m_Wrapper.m_TitleMapActionsCallbackInterface.OnNewaction;
                @Newaction.canceled -= m_Wrapper.m_TitleMapActionsCallbackInterface.OnNewaction;
            }
            m_Wrapper.m_TitleMapActionsCallbackInterface = instance;
            if (instance != null)
            {
    ...
    public struct BattleMapActions
    {
        ...
        public void SetCallbacks(IBattleMapActions instance)
        {
            ...
            {
                @Newaction.started -= m_Wrapper.m_BattleMapActionsCallbackInterface.OnNewaction;
                @Newaction.performed -= m_Wrapper.m_BattleMapActionsCallbackInterface.OnNewaction;
                @Newaction.canceled -= m_Wrapper.m_BattleMapActionsCallbackInterface.OnNewaction;
            }
    ...
    private ICutsceneMapActions m_CutsceneMapActionsCallbackInterface;
    ...
    public struct CutsceneMapActions
    {
        ...
        {
            if (m_Wrapper.m_CutsceneMapActionsCallbackInterface != null)
            {
                @Newaction.started -= m_Wrapper.m_CutsceneMapActionsCallbackInterface.OnNewaction;
                @Newaction.performed -= m_Wrapper.m_CutsceneMapActionsCallbackInterface.OnNewaction;
                @Newaction.canceled -= m_Wrapper.m_CutsceneMapActionsCallbackInterface.OnNewaction;
            }
            m_Wrapper.m_CutsceneMapActionsCallbackInterface = instance;
            if (instance != null)
            {
                @Newaction.started += instance.OnNewaction;
                @Newaction.performed += instance.OnNewaction;
